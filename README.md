...
6. **관심 접수:** 「N번 맘에 들어요」 DM이 온 대화에서 게시 번호를 넣고 「관심 접수」를 누르면 관리자의 관심 문의 파이프라인에 등록됩니다. 스펙 답장이 온 대화에서 「이 대화 수집」을 누르면 수집된 프로필이 그 문의에 자동 연결됩니다. 전달 큐 항목에는 종류(스펙 문의/스펙 전달/성사 안내)가 표시됩니다.
